...
class TestXmlDocumentParserClass:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (TEST_TOOL_01_DOCUMENT, Position(line=0, character=5), NodeType.ELEMENT),
            (TEST_TOOL_01_DOCUMENT, Position(line=0, character=7), NodeType.ATTRIBUTE_KEY),
            (TEST_TOOL_01_DOCUMENT, Position(line=0, character=8), NodeType.ATTRIBUTE),
            (TEST_TOOL_01_DOCUMENT, Position(line=0, character=9), NodeType.ATTRIBUTE_VALUE),
            (TEST_TOOL_01_DOCUMENT, Position(line=0, character=14), NodeType.ATTRIBUTE_VALUE),
            (TEST_TOOL_01_DOCUMENT, Position(line=0, character=15), NodeType.ELEMENT),
            ...
            (TEST_TOOL_01_DOCUMENT, Position(line=1, character=39), NodeType.CDATA_SECTION),
            (TEST_TOOL_01_DOCUMENT, Position(line=2, character=0), NodeType.CDATA_SECTION),
            (TEST_TOOL_01_DOCUMENT, Position(line=3, character=5), NodeType.CDATA_SECTION),
            (TEST_TOOL_01_DOCUMENT, Position(line=3, character=6), NodeType.CONTENT),
